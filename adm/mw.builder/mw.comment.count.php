...
$sql_search = " where wr_id <> wr_parent and (bn_datetime between '$fr_date 00:00:00' and '$to_date 23:59:59') ";
$sql_group  = " group by day ";
$sql_order = " order by bn_datetime desc ";

switch ($ymd) {
    case "y":
        $sql_select .= ", left(bn_datetime, 4) as day ";
        break;
    case "m":
        $sql_select .= ", left(bn_datetime, 7) as day  ";
        break;
    default:
	$ymd = "d";
        $sql_select .= ", left(bn_datetime, 10) as day  ";
        break;
}
