...
{
    $html_title .= " 생성";
    $pp[pp_start] = "$g4[time_ymd]";
    $pp[pp_end] = date("Y-m-d", $g4[server_time]+(86400*7));
    $pp_use = "checked";
    $pp_type_1 = "checked";
...
else if ($w == "u") 
{
    ...
    $pp_time_1 = $pp_time_7 = $pp_time_30 = "";
...
<tr class='ht'>
    <td>시작일</td>
    <td>
        <input type='text' class=ed name=pp_start id=pp_start maxlength=10 size=10 required itemname='시작일' value='<?=$pp[pp_start]?>'>
    </td>
    <td>종료일</td>
    <td>
        <input type='text' class=ed name=pp_end id=pp_end maxlength=10 size=10 required itemname='종료일' value='<?=$pp[pp_end]?>'>
    </td>
</tr>
<tr class='ht'>
    <td>창위치 위</td>
...
<tr class='ht'>
	...
	<input type="radio" name="pp_time" value="7" <?=$pp_time_7?>> 일주일 
