...
for ($i=0; $row=sql_fetch_array($result); $i++) 
{
    ...
    echo "<td><input type=text name=ms_name[$i] size=50 value='$row[ms_name]' class=ed></td>";
    echo "<td><select id=bo_tables_$i name=bo_tables[$i]><option value=''></option>$board_options</select></td>";
