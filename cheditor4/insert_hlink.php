  ...
  <tr>
    <td>
      ...
      <table border="0" cellspacing="4">
        <tr>
          <td align="right" width="40"><span class="normal"><?php echo $lang['268'];?>:</span>
          </td>
          <td>
          ...
          <td align="right"><span class="normal"><?php echo $lang['269'];?>:</span>
          </td>
          <td>
            <select name="target" id="fm_target">
              <option value="" /><?php echo $lang['270'];?>
        ...
        <tr>
          <td align="right"><span class="normal"><?php echo $lang['271'];?>:</span>
          </td>
          <td colspan="3">
...
<div align="center">
<button class="button" onclick="returnSelected()"><?php echo $lang['232'];?></button>&#160;<button class="button" onclick="popupClose()"><?php echo $lang['267'];?></button>
</div>
</body>
</html>
