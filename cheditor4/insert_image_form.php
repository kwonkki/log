...
<div id="tmpImage"></div>
<fieldset><legend><span class="normal"><?php echo $lang['274'];?></span></legend>
...
<button id="delete_btn" class="button" onclick="deleteImage()" disabled="true"><?php echo $lang['82'];?></button>
</div>
</fieldset>
<div style="margin:10px 0px 10px 0px">
<fieldset><legend><span class="normal"><?php echo $lang['275'];?></span></legend>
...
<div style="text-align:center;">
    <button onclick="doSubmit()" id="submit_btn" class="button" disabled="true"><?php echo $lang['232'];?></button>&#160;
