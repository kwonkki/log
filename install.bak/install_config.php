...
<div align="center">
  ...
  <table width="587" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      <td width="3" background="img/box_left.gif"><img src="img/box_left.gif" width="3" height="340"></td>
      <td width="581" valign="top" bgcolor="#FCFCFC"><table width="581" border="0" cellspacing="0" cellpadding="0">
        ...
        <table width="540" border="0" align="center" cellpadding="0" cellspacing="0" class="body">
          <tr> 
            <td width="270" height="16" valign="top"><strong>MySQL 정보입력 </strong><br>
              <br>
              <table width="270" border="0" cellpadding="0" cellspacing="0" class="body">
                ...
                <tr> 
                  ...
                  <td><input name="mysql_db" type="text" class="box"></td>
                    ...
                    <br><br>
                <strong>배추빌더 설정</strong> <br>
              <br>
              <table width="270" border="0" cellpadding="0" cellspacing="0" class="body">
                <tr> 
                  <td width="80" align="right" height=30>스킨 :&nbsp;</td>
                  <td>
                    <select name="mwt">
            ...
            <td valign="top"><strong>최고관리자 정보입력</strong> <br>
              <br>
              <table width="270" border="0" cellpadding="0" cellspacing="0" class="body">
                <tr> 
        ...
        <br>
        <table width="551" height="50" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr> 
            <td align="right"> 
      ...
      <td width="3" background="img/box_right.gif"><img src="img/box_right.gif" width="3" height="340"></td>
    </tr>
    <tr> 
