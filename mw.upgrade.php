...
@mysql_query("alter table $g4[group_table] add gr_skin_tail varchar(50) not null default 'mw.basic.{$mwt}' after gr_use_access");
@mysql_query("alter table $g4[group_table] add gr_skin_home varchar(50) not null default 'mw.basic.{$mwt}' after gr_use_access");
@mysql_query("alter table $g4[group_table] add gr_skin_main varchar(50) not null default 'mw.basic.{$mwt}' after gr_use_access");
@mysql_query("alter table $g4[group_table] add gr_skin_head varchar(50) not null default 'mw.basic.{$mwt}' after gr_use_access");
...
mm_skin varchar(50) not null default 'mw.basic.{$mwt}',
...
,cf_index_skin_head varchar(50) not null default 'mw.basic.{$mwt}'
,cf_index_skin_main varchar(50) not null default 'mw.basic.{$mwt}'
,cf_index_skin_tail varchar(50) not null default 'mw.basic.{$mwt}'
,cf_index_cache int not null default 10 
,cf_index_width int not null default 800
,cf_member_skin_head varchar(50) not null default 'mw.basic.{$mwt}'
,cf_member_skin_tail varchar(50) not null default 'mw.basic.{$mwt}'
);";
@mysql_query($sql);
