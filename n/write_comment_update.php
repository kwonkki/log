...
if ($w == "c") // 코멘트 입력
{
    ...
    */
    ...
    // 포인트 부여
    insert_point($member[mb_id], $board[bo_comment_point], "$board[bo_subject] {$wr_id}-{$comment_id} {$lang[473]}", $bo_table, $comment_id, '{$lang[255]}');
    ...
    if ($config[cf_email_use] && $board[bo_use_email])
    {
        ...
        $wr_content = nl2br(get_text(stripslashes("----- {$lang[267]} -----\n\n$wr[wr_subject]\n\n\n----- {$lang[255]} -----\n\n$wr_content")));
