 ...
 */
 ...
 function sendEmail($body){
	...
	$arrCCAddress = array("jeffrey@pacificseainvests.com", "kelly.tmm@pacificseainvests.com", "kibum.kk@pacificseainvests.com" );
...
include(dirname(__FILE__)."\email-result-export.php");
