	...
	<tr>
		...
		<table border="0" width="100%" id="table3" cellspacing="0" cellpadding="0">
			...
			<div style="float:left; margin-top:6px;">
				...
				<td align="right">
				<table border="0" id="table4" cellspacing="1">
					<tr>
						<td align="center">
				<a class="btn5" href="<?=$copy_href?>"><?php echo $lang['78'];?></a></td>
						<td align="center">
				<a class="btn5" href="<?=$move_href?>"><?php echo $lang['79'];?></a></td>
						<td align="center">
				<a class="btn2" href="<?=$search_href?>"><?php echo $lang['80'];?></a></td>
						<td align="center">
				<a class="btn6" href="<?=$list_href?>"><?php echo $lang['75'];?></a></td>
						<td align="center">
				<a class="btn6" href="<?=$update_href?>"><?php echo $lang['81'];?></a></td>
						<td align="center">
				<a class="btn6" href="<?=$delete_href?>"><?php echo $lang['82'];?></a></td>
						<td align="center">
				<a class="btn6" href="<?=$reply_href?>"><?php echo $lang['83'];?></a></td>
						<td align="center">
				<a class="btn1" href="<?=$write_href?>"><?php echo $lang['76'];?></a></td>
					</tr>
				</table>
				</td>
			</tr>
...
?>
		...
		<div style="clear:both; height:43px;">
			<div style="float:left; margin-top:10px; width:40px; height:45px">
			<table border="0" width="100%" id="table6" cellspacing="1">
				<tr>
					<td align="center">
			<a class="btn11" href="<?=$prev_href?>"><?php echo $lang['124'];?></a></td>
					<td align="center">
			<a class="btn11" href="<?=$next_href?>"><?php echo $lang['125'];?></a></td>
				</tr>
			</table>
&nbsp;</div>
