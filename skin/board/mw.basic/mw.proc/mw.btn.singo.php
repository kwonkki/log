...
//if ($write[wr_singo]) alert_only("이미 신고된 게시물 입니다.");
...
<table class="tout" border="0" cellpadding="0" cellspacing="2">
<col width="60"/>
<col width="410"/>
<tr>
    <td class="tdh"> 분류 </td>
...
<tr>
    ...
    <td class="tdb">
        <textarea name="content" itemname="신고내용" cols="60" rows="5" class="mw_basic_textarea"></textarea>
    </td>
</tr>
</table>
