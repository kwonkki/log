...
// [s][/s] 태그처리
$view[rich_content] = preg_replace("/\[s\](.*)\[\/s\]/iU", "<s>$1</s>", $view[rich_content]);
$view[rich_content] = preg_replace("/\[b\](.*)\[\/b\]/iU", "<b>$1</b>", $view[rich_content]);
...
document.title = "<?=addslashes($view[wr_subject])?>";
</script>
