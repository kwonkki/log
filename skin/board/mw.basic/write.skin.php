...
<td>
    ...
    <span style="color:#888;">(나의 <?=$mw_cash[cf_cash_name]?> <?=$mw_cash[mb_cash]?> <?=$mw_cash[cf_cash_unit]?>
...
<td>
    ...
    색상 : <select name="wr_subject_color" id="wr_subject_color">
...
if ($mw_basic[cf_vote] && $mw_basic[cf_vote_level] <= $member[mb_level]) { 
    ...
    if ($vote[vt_edate] == "0000-00-00")
        $vote[vt_edate] = "";
?>
<tr>
<td class=mw_basic_write_title>· 설문종료일 </td>
<td class=mw_basic_write_content>
