    ...
    <td colspan="2" style="padding:5px 0 0 5px;">
        ...
        <? if ($is_guest) { ?>
            ...
            패스워드 <INPUT type=password maxLength=20 size=10 name="wr_password" itemname="패스워드" required class=ed>
					<img id='kcaptcha_image' border='0' width=70 height=30 valign="bottom" onclick="imageClick();" style="cursor:pointer;" title="글자가 잘안보이는 경우 클릭하시면 새로운 글자가 나옵니다.">
					<INPUT title="왼쪽의 글자를 입력하세요." type="input" name="wr_key" itemname="자동등록방지" required class=ed>
