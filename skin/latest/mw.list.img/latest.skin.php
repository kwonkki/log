...
.<?=$style_name?> .file { width:140px; height:80px; padding-bottom:5px; }
.<?=$style_name?> .file-img { width:120px; height:80px; border:2px solid #e2d2e2; }
.<?=$style_name?> .post-img a:hover img { border:2px solid #ff4e00; }
