...
#mw-outlogin .box-inside { position:absolute; margin:2px; width:176px; height:96px; background-color:#f3f9fc; background-color:#fff; line-height:16px; color:#7dacd8; font-size:8pt; font-family:gulim }
...
#mw-outlogin .login-membership { position:absolute; margin:72px 0 0 7px; padding:3px 0 0 0; border-top:1px solid #d0e1f1; width:162px; text-align:center; font-size:8pt; color:#d0e1f1; }
