...
<div class="box-inside">
    <div class="login-title"><strong>SMS</strong> login</div>
    <input type="text" name="mb_id" id="mb_id" class="login-mb_id" value="ID">
...
<div class="login-membership">
    <a href="<?=$g4[bbs_path]?>/register.php"><strong>Register</strong></a>
</div>
</div>
</form>
</div>
