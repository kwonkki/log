...
<div class="box-inside">
    ...
    <div class="login-cash"><a href="<?=$g4[path]?>/plugin/cybercash/"><strong><?=$mw_cash[cf_cash_name]?></strong>: <span class="login-cash-number"><?=number_format($mw_cash[mb_cash])?></span> <?=$mw_cash[cf_cash_unit]?></a></div>
...
#mw-outlogin .box-inside { position:absolute; margin:2px; width:246px; height:96px; background-color:#f3f9fc; background-color:#fff; }
#mw-outlogin .box-inside { line-height:16px; color:#7dacd8; font-size:8pt; font-family:gulim }
#mw-outlogin .login-title { position:absolute; margin:5px 0 0 7px; width:232px; border-bottom:1px solid #d0e1f1; }
#mw-outlogin .login-memo { position:absolute; margin:30px 0 0 160px; }
#mw-outlogin .login-memo-count { font-size:8pt; color:#ff6600; }
#mw-outlogin .login-point { position:absolute; margin:50px 0 0 7px; }
#mw-outlogin .login-point-number { color:#ff6600; color:#468AC8; }
#mw-outlogin .login-cash-number { color:#ff6600; color:#57A418; }
#mw-outlogin .login-days { position:absolute; margin:30px 0 0 7px; }
#mw-outlogin .login-cash { position:absolute; margin:50px 0 0 160px; }
#mw-outlogin .login-membership { position:absolute; margin:72px 0 0 7px; padding:3px 0 0 0; border-top:1px solid #d0e1f1; width:232px; }
