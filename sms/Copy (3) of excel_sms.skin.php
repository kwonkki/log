...
<div>
	...
	<input type="file" id="excel_reading" class="excel_reading" name="excel_reading" value="loading the excel"   onchange="this.select(); document.getElementById('filetext').value=document.selection.createRange().text.toString();" />
	<input type="hidden" id="filetext" />
	<span><a href="./phone.xls">download excel fiel</a></span>
